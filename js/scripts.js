(function($){
  ...
  $('.local-scroll').localScroll({offset: {top: -50},duration: 1500,easing:'easeInOutExpo'});
  ...
  function initTwittslider(){
    $('.twitter-slider #tweets ul').addClass('owl-carousel owl-theme owl-dark-dots text-center').attr('id', 'owl-single');
  }
  ...
  function initOwlCarousel(){
    (function($){
      ...
      // twitter replace with client slider
      $("#owl-4-items-client").owlCarousel({
              navigationText: ["<i class='ti-angle-left slider-arrow'></i>", "<i class='ti-angle-right slider-arrow'></i>"],
        navigation: true,
        slideSpeed: 300,
        pagination: true,
        paginationSpeed: 400,
      ...
      // partner slider
      $("#owl-4-items-partner").owlCarousel({
  ...
  $('.service-item-box.style-2').hover(function(){
    $(this).find('.hidden-text').slideDown("easeOutExpo").animate({opacity: 1},{queue: false});    
  },
  function(){
    $('.hidden-text').slideUp("easeOutExpo").animate({opacity: 0},{queue: false});
  });
...
function container_full_height_init(){
  (function($){
    ...
    $(".container-full-height").height(windowHeight);
  })(jQuery);
}
